        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GitHubLogin = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    GitHubAccessToken = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    GitHubConnectedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequiredSecrets = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    Profile = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AvailableProfiles = table.Column<string>(type: "nvarchar(max)", nullable: true),
